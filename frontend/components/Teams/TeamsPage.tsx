    ...
    return (
      <div className="min-h-screen bg-[#F7F8FA] flex items-center justify-center">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#6B778C] font-medium">Loading teams...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-[#F7F8FA] text-[#172B4D]">
      ...
      <div className="bg-white border-b border-[#E4E7EB] shadow-sm sticky top-0 z-40">
        <div className="max-w-7xl mx-auto px-6 py-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-3xl font-bold text-[#172B4D]">Teams</h1>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex items-center gap-2 px-4 py-2 text-[#172B4D] bg-white border border-[#E4E7EB] hover:bg-[#F4F5F7] rounded-lg transition-colors font-medium"
                title="Refresh teams"
              >
        ...
        {teams.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 bg-white rounded-lg border border-dashed border-[#E4E7EB]">
            <div className="text-center space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-[#172B4D]">No teams yet</h3>
                <p className="text-[#6B778C] mt-1">Create your first team to get started</p>
              </div>
              {isManager && (
                <button
                  onClick={() => setShowCreateModal(true)}
                  className="mt-4 px-6 py-2 bg-[#0052CC] hover:bg-[#0747A6] text-white rounded-lg font-medium transition-colors"
                >
                  Create Team
                </button>
              )}
      ...
      <TeamMembersModal
        ...
        onMembersUpdated={() => viewingTeam && fetchTeamMembers(viewingTeam.teamId || viewingTeam.id || '')}
      />
    </div>
  );
}
